...
Just ask your AI agent to create a playbook:
...
```bash
cp schemas/org-standard-template.yaml ~/.agent/playbook-standards/my-company.yaml
...
2. **Org overrides** (`~/.agent/playbook-standards/*.yaml`) — merged on top
