...
description: >
  ...
  response plan, deployment guide, or any step-by-step operational document.
user-invokable: true
args:
  - name: domain
    description: The domain or system this playbook covers (e.g. "Azure AI Foundry deployment", "credential rotation")
    required: true
---
...
1. Copy `schemas/org-standard-template.yaml` to `~/.agent/playbook-standards/{client-name}.yaml`
