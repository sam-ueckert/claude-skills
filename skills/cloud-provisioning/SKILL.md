...
description: >
  ...
  cloud platform. Walks through step-by-step onboarding with least-privilege policies
  and stores credentials via the secret-vault skill.
user-invokable: true
args:
  - name: cloud
    description: Which cloud provider to onboard (aws, azure, gcp, or "all")
    required: true
---
