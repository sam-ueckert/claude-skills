...
# @raycast.title Paste Image to Agent
# @raycast.mode silent
...
on error
  display notification "No image found in clipboard" with title "Paste Image to Agent"
...
-- Simulate Cmd+V so the agent picks it up as a file attachment
