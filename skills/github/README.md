...
If you don't have a PAT yet, ask your AI agent: "Set up my GitHub credentials" — it will walk you through creating a fine-grained token with minimum required scopes.
